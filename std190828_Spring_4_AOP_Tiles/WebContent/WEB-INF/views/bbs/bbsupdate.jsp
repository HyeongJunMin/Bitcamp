...
<div class="mainContiner">
	...
	<div class="bbsDetailNavWrap">
		<input type="button" value="돌아가기" onclick="location.href='<%=request.getContextPath()%>/showbbsdetail.do?seq=${BbsDto.seq }'">		
	...
	$("#btnUpdate").click(function(){
		...
		$.ajax({
			...
			success:function(resp){
				...
				if( resp === 1){
					alert('수정이 완료되었습니다.');
					location.href="showbbsdetail.do?seq=" + viewData["seq"];
				}else{
