...
//				JOptionPane.showMessageDialog(null, "변경있음");
				if(txtAuth.getText().equals("3") || txtAuth.getText().equals("1")) {
					DTOMem dto2 = new DTOMem(txtId.getText(), txtPw.getText(), txtName.getText(), txtEmail.getText(), Integer.parseInt(txtAuth.getText()));
//					System.out.println(dto2.toString());
					boolean done = s.memCtrl.updateMember(dto2); 
					if( done ) {
						JOptionPane.showMessageDialog(null, "수정완료");
						s.memCtrl.syncDBToMap();
					}else {
