...
<!-- Custom js, css -->
<script type="text/javascript" src="./js/freeboardmain.js"></script>
<script type="text/javascript" src="./js/modalSignin.js"></script>
<script type="text/javascript" src="./js/modalSignup.js"></script>
<link rel="stylesheet" type="text/css" href="./css/freeboardmain.css"></link>
